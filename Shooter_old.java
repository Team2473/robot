...
//	
//	public static int fwdPot = 505; //failsafe
//	public static int backPot = 420; //failsafe
//	
//	public static double delta;
//	//make backwards array by flipping fwdTable or make 2D array
//	public static double[] fwdTable = {0.28, 0.26, 0.23, 0.22, 0.21, 0.20, 0.19, 0.18, 0.17, 0.17, 0.16, 0.15, 0.12, 0.08, 0.08, 0.08, 0.08, 0.06, 0.06, 0.02};  
//	
//	public Shooter(){
...
//		SmartDashboard.putString("DB/String 1", "Rev: " + pot.isRevLimitSwitchClosed());
//	}
//	
...
//	
//	
//	public static void mapBackMid(){
//		int count3 = 0;
//		for(double i = fwdPot - delta; i > (backPot+fwdPot)/2; i -= delta){
//			while(pot.getAnalogInRaw() > i && count3 < fwdTable.length){
//				pot.set(-fwdTable[count3]);
//			}
//			count3++;
//		}
//	}
...
//	
//	
//	public static boolean continueMethod = false;
//	
//	public static DigitalInput spin = new DigitalInput(0); 
//	
//	public static void load(){
//		SmartDashboard.putString("DB/String 4", "spin.get: " + spin.get());
...
//				shootL.set(0.2);
//			}
////			SmartDashboard.putString("DB/String 0", "Got to 0");
//			shootR.set(0);
//			shootL.set(0);
//			continueMethod = true;
////			SmartDashboard.putString("DB/String 1", "Got to 1");
//		}
//		if(!joy1.getRawButton(4) && continueMethod){ 				//button release
////			SmartDashboard.putString("DB/String 2", "Got to 2");
//			if(spin.get()){
//				mapBackTable(100);
////				SmartDashboard.putString("DB/String 3", "Got to 3");
//			}
//			else{
////				SmartDashboard.putString("DB/String 4", "Got to 4");
