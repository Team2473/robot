...
public class TeleOp {
	...
	public static void runPowerReverse() {
		...
		double leftY = Controller.getInstance().getYRNeg()
				/ Math.abs(Controller.getInstance().getYRNeg())
				* Math.sqrt(Math.abs(Controller.getInstance().getYRNeg()));
		double rightY = Controller.getInstance().getYLNeg()
				/ Math.abs(Controller.getInstance().getYLNeg())
